# KRINEIA.md — hummbl-bibliography

**krineia_manifest_version:** 0.1
**schema:** krineia-manifest@0.1

This is the repo-local KRINEIA manifest for `hummbl-dev/hummbl-bibliography`.
...
repo:
  full_name: "hummbl-dev/hummbl-bibliography"
  default_branch: "main"
  visibility: "private"
...
chains:
  primary:
    chain_id: "hummbl-bibliography-primary"
